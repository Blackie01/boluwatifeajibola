          ...
          >
            ...
            >
             ...
             <div className="flex items-center gap-6 text-[#a0a0a0]">
              <a href="https://www.linkedin.com/in/boluajibola/" className="hover:text-white transition-colors h-8 w-8 border border-[currentColor] rounded-full flex items-center justify-center" aria-label="LinkedIn">
              ...
              <a href="https://x.com/_boluajibola?s=11" className="hover:text-white transition-colors h-8 w-8 border border-[currentColor] rounded-full flex items-center justify-center" aria-label="Twitter">
              ...
              <a href="https://www.instagram.com/_boluajibola/" className="hover:text-white transition-colors h-8 w-8 border border-[currentColor] rounded-full flex items-center justify-center" aria-label="Instagram">
