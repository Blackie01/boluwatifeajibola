                ...
                <div className="absolute inset-0 w-full h-full flex items-end justify-between p-6">
                    ...
                    >
                        ...
                        <div className="block md:hidden text-left mb-2">
                            ...
                            <h1
                                className="text-[16px] text-white/80 font-light leading-[1.3] tracking-wide mt-2"
                        ...
                        <div className="hidden md:flex w-full items-end justify-between">
                            ...
                            <div className="text-left">
                                ...
                                <h1
                                    ...
                                    style={{ fontFamily: "var(--font-outfit)" }}
                                >
                                    Creativity processes <br />experiences
                                </h1>
                            </div>
            ...
            <div className="bg-white w-full py-24 md:py-32 relative z-10">
                <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
                    ...
                    <div className="hidden lg:grid grid-cols-3 gap-6">
                        {[1, 2, 3, 4].map((num) => (
                            <div key={`cartoon-${num}`} className="w-full aspect-square relative overflow-hidden rounded-sm group border border-[#0a0a0a]/20">
                                <Image src={`/cartoon${num}.png`} alt={`NaijaPolitoons Cartoon ${num}`} fill className="object-cover filter grayscale group-hover:grayscale-0 transition-all duration-700 ease-out scale-105 group-hover:scale-100" sizes="(max-width: 1024px) 33vw, 400px" />
                        ...
                        <div className="w-full aspect-square flex flex-col justify-center items-center text-center p-4 bg-gray-50 border border-gray-100 rounded-sm border border-[#0a0a0a]/20 relative overflow-hidden group">
                            ...
                            <p className="text-[14px]  text-[#4a4a4a] leading-relaxed mb-2">
                                My creative work also extends into writing, satire, storytelling, and civic imagination. In 2020, I co-founded NaijaPolitoons, a creative civic platform that uses humour and cartooned content as advocacy instruments.
                            </p>
                            <p className="text-[14px]  text-[#4a4a4a] leading-relaxed mb-6">
                                Through satire, visual commentary, and accessible political messaging, NaijaPolitoons promotes democratic values, citizen education, accountability, and good governance.
                            </p>
                            <ActionText text="Explore NaijaPolitoons" href="https://www.instagram.com/npolitoons" theme="light" />
                        </div>
                    ...
                    <div className="flex flex-col lg:hidden gap-12">
                        ...
                        <div className="flex flex-col items-start text-left px-4">
                            ...
                            <div className="flex flex-col gap-4 text-[14px] text-[#4a4a4a] leading-relaxed mb-8 max-w-2xl">
                                <p>My creative work also extends into writing, satire, storytelling, and civic imagination.</p>
                                <p>In 2020, I co-founded NaijaPolitoons, a creative civic platform that uses humour and cartooned content as advocacy instruments. Through satire, visual commentary, and accessible political messaging, NaijaPolitoons promotes democratic values, citizen education, accountability, and good governance.</p>
                                <p>NaijaPolitoons sits at the intersection of creativity, activism, and public engagement. It shows how artistic and humorous forms can contribute to civic education and democratic conversation, especially in contexts where people are disengaging.</p>
                            </div>
                            <ActionText text="Explore NaijaPolitoons" href="https://www.instagram.com/npolitoons?igsh=MWJoZzZ5ZWtxMnhtbA==" theme="light" />
                        </div>

                        {/* Image Grid */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {[1, 2, 3, 4, 5, 6, 7, 8].map((num) => (
                                <div key={`cartoon-mobile-${num}`} className="w-full aspect-square relative overflow-hidden rounded-sm group shadow-sm">
                                    <Image src={`/cartoon${num}.png`} alt={`NaijaPolitoons Cartoon ${num}`} fill className="object-cover filter grayscale group-hover:grayscale-0 transition-all duration-700 ease-out scale-105 group-hover:scale-100" sizes="(max-width: 768px) 50vw, 25vw" />
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-6 text-[16px] md:text-[18px] max-w-2xl text-[#a0a0a0] leading-relaxed">
                                <p>
