        ...
        return (
            <main className="min-h-screen bg-[#0C0C0C] text-white pt-48 flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-3xl mb-4 font-medium" style={{ fontFamily: "var(--font-outfit), sans-serif" }}>Paper not found</h1>
                    <Link href="/conference-papers" className="text-[#d4af37] underline hover:text-white transition-colors duration-300">
                        Back to papers
                    </Link>
                </div>
            </main>
    ...
    return (
        <main className="min-h-screen bg-[#0C0C0C] text-white pt-48 pb-32 px-6 md:px-12 flex flex-col justify-start overflow-clip">
            <div className="max-w-4xl mx-auto w-full">
                <Link href="/conference-papers" className="inline-flex items-center gap-2 text-[#a0a0a0] hover:text-white transition-colors duration-300 mb-12 group">
                    <svg 
                ...
                >
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl leading-tight font-medium text-white mb-8" style={{ fontFamily: "var(--font-outfit), sans-serif" }}>
                        {paper.title}
                    </h1>

                    <div className="text-[16px] text-[#a0a0a0] mb-16 border-b border-white/10 pb-12 font-light">
                        Presented at the <span className="text-gray-200">{paper.conferenceName}</span>
                    </div>
                </motion.div>
