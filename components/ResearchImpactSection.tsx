...
const helpWithItems = [
  "Research project delivery and report writing",
  "Grant and proposal development",
  "Bid review and proposal strengthening",
  "Funding opportunity mapping",
  "Research strategy and project scoping",
  "Impact planning and evidencing",
  "Stakeholder mapping and engagement planning",
  "Research communication and public engagement",
  "REF-informed research or impact planning",
  "Training on research impact",
];

const goodFitItems = [
  "NGOs or civic organisations designing or delivering research projects",
  "Academics developing proposals",
  "Research teams preparing funding bids",
  "Departments strengthening research culture",
  "NGOs or civic organisations designing research projects",
  "Organisations needing evidence-informed strategy",
];
...
export default function ResearchImpactSection() {
  return (
    <section id="research-impact" className="w-full bg-[#fbfbfb] text-[#0a0a0a] py-24 md:py-32 px-6 md:px-12 lg:px-24 border-t border-black/10 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start relative">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 md:lg:top-32 flex flex-col justify-between gap-8 self-start z-20 pb-12">
            <div className="flex flex-col gap-6">
              ...
              >
                Research Development & Impact Support
              </motion.h2>
              ...
              <div className="p-5 rounded-none bg-black/[0.03] border-l-2 border-black/80 flex flex-col gap-1.5">
                <p className="text-sm md:text-[15px] font-medium text-[#222] leading-relaxed">
                  For researchers, research teams, organisations, NGOs, think tanks, funders and policy-facing organisations.
                </p>
              </div>

              {/* Body Description */}
              <p className="text-base text-[#444] font-light leading-relaxed">
                I work with individuals and teams to strengthen research ideas, develop more compelling proposals, identify pathways to impact, and design engagement strategies that connect evidence with public value. I can also work with organisations to deliver research projects.
              </p>
            </div>
            ...
            <div className="pt-6 border-t border-black/10">
              <div className="text-base md:text-lg font-medium">
                <ActionText
                  text="Discuss a research or impact project"
                  href="/contact"
                  theme="light"
                />
              </div>
